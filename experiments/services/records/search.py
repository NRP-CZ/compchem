...
class ExperimentsSearchOptions(InvenioSearchOptions):
    ...
    facets = {
        "metadata_creators_affiliation": facets.metadata_creators_affiliation,
        "metadata_creators_name": facets.metadata_creators_name,
        "metadata_creators_orcid": facets.metadata_creators_orcid,
        "metadata_fundingReference_awardNumber": facets.metadata_fundingReference_awardNumber,
        "metadata_fundingReference_funderIdentifier": facets.metadata_fundingReference_funderIdentifier,
        "metadata_fundingReference_funderName": facets.metadata_fundingReference_funderName,
        "metadata_objectIdentifiers_identifier": facets.metadata_objectIdentifiers_identifier,
        "metadata_objectIdentifiers_identifierType": facets.metadata_objectIdentifiers_identifierType,
