...
def create_api_blueprint(app):
    """Create ExperimentsFileDraft blueprint."""
    blueprint = app.extensions["experiments"].resource_draft_files.as_blueprint()
    ...
    funcs = [
        ...
        if k.startswith("init_addons_experiments_file_draft") and callable(v)
    ]
    for func in funcs:
