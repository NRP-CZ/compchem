...
def create_api_blueprint(app):
    """Create ExperimentsFile blueprint."""
    blueprint = app.extensions["experiments"].resource_files.as_blueprint()
    ...
    funcs = [
        ...
        if k.startswith("init_addons_experiments_file") and callable(v)
    ]
    for func in funcs:
...
def init_addons_experiments_file_published_service(state):
    """Init app."""
    app = state.app
    ext = app.extensions["experiments"]
