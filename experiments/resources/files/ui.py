...
class ExperimentsFileUIJSONSerializer(LocalizedUIJSONSerializer):
    ...
    def __init__(self):
        ...
        super().__init__(
            ...
            object_schema_cls=ExperimentsFileUISchema,
            list_schema_cls=BaseListSchema,
            schema_context={"object_key": "ui", "identity": g.identity},
        )


class ExperimentsFileDraftUIJSONSerializer(LocalizedUIJSONSerializer):
    """UI JSON serializer."""
    ...
    def __init__(self):
        ...
        super().__init__(
            format_serializer_cls=JSONSerializer,
            object_schema_cls=ExperimentsFileDraftUISchema,
            list_schema_cls=BaseListSchema,
            schema_context={"object_key": "ui", "identity": g.identity},
        )
